...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $query->setStrippedQueryText(str_replace($replaceSymbols, ' ', $query->getQueryText()));
        if (strpos($this->scopeConfig->getValue(EngineProvider::CONFIG_ENGINE_PATH), 'mysql') !== false) {
            $query->setQueryText($query->getStrippedQueryText()); //replace only for mysql (for a search by products)
        }
