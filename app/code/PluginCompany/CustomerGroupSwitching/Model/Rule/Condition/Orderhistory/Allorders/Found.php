    ...
    extends Combine
{
    ...
    {
        $this->setType('PluginCompany\CustomerGroupSwitching\Model\Rule\Condition\Orderhistory\Allorders\Found');
        return $this;
    }
     ...
     * Load value options
     *
     * @return \Magento\SalesRule\Model\Rule\Condition\Orderhistory\Found
     */
    ...
    public function asHtml()
    {
        ...
        $html =
            ...
            . __(
                "If an order is %1 in the order history %2"
    ...
    public function validateDataObject(DataObject $object)
    {
        ...
        foreach ($this->getRule()->getOrderCollection($period['from'],$period['to']) as $item) {
