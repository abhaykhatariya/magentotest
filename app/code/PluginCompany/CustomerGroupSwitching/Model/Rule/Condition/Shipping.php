...
/**
 * Class \PluginCompany\CustomerGroupSwitching\Model\Rule\Condition\Shipping
 */
...
class Shipping extends AbstractCondition
{
    ...
    public function loadAttributeOptions()
    {
        $attributes = [
            ...
            'shipping_postcode' => __('Postcode'),
            'shipping_region' => __('State/Province (text)'),
            'shipping_region_id' => __('State/Province (dropdown)'),
    ...
    public function getInputType()
    {
        switch ($this->getAttribute()) {
            case 'shipping_country_id': case 'shipping_region_id':
            return 'select';
        }
        return 'string';
    }
